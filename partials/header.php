...
<head>
    ...
    <?php
        if (empty($metaDescription))
            $metaDescription = 'NHN Computer - Laptop, linh kiện máy tính, Laptop Gaming, Laptop Văn Phòng, Siêu thị máy tính';
    ?>
     <?php
        if (empty($metaKeywords))
            $metaKeywords = 'NHN Computer, laptop, máy tính xách tay, linh kiện máy tính, laptop gaming, Laptop Văn Phòng';
    ?>
    ...
    <?php
        if (empty($openGraph)) {
            $propertyTitle = 'NHN Computer - Laptop, linh kiện máy tính';
            $propertyDescription = 'NHN Computer, laptop, linh kiện máy tính, laptop gaming, Laptop Văn Phòng';
            $propertyUrl = 'http://nhncomputer.epizy.com/';
            $propertyImage = 'http://nhncomputer.epizy.com/public/image/logo.png';
            $propertyImageAlt = 'NHN Computer - Laptop, linh kiện máy tính';
        }
    ?>
    ...
    <?php
     if (empty($titlePage)) {
         $titlePage = 'NHN Computer | Laptop, linh kiện máy tính chính hãng';
     } ?>
            ...
            <div class="container">
                <div class="row">
                    <div class="wrapper-logo">
                        <a title="NHN COMPUTER" href="<?=BASE_URL?>index.php"><img src="<?=BASE_URL?>public/image/logo.png" alt="NHN COMPUTER"></a>
                    </div>
                    <div class="wrapper-search">
                        <form action="<?=BASE_URL?>tim-kiem.php" method="GET" id="form-search">
                            <div class="form-group">
                                <input type="text" placeholder="Nhập tên sản phẩm" name="q" class="form-control" value="<?php if(!empty($keyword)) echo $keyword;?>">
                   ...
                   <div class="header-left">
                        <div class="wrapper-auth">
                            <?php
                                ...
                                //     echo ' <a href="'.BASE_URL.'customer.php" class="icon-auth">
                                //                 <img src="'.$customerInfo['avatar'].'">
                                //             </a>';
                                // }
                                // else {
                                //         echo ' <button class="icon-auth">
                ...
                <div class="row">
                    <div class="col col-xl-2">
                        <div class="header-category">
                            <span class="header-btn <?php if (isset($isHomePage)) echo 'disabled';?>"><i class="fas fa-bars"></i> DANH MỤC SẢN PHẨM
...
<script type="module"> 
    import { removeDuplicateSpaceAndTrim, noSpecialChars } from '<?=BASE_URL?>public/js/validate.js';
...
<script>
    ...
    function hideMessage() {
        $('#box-message .message').css({"transform": "scale(0)"})
